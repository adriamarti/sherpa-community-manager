...
export default function Hero() {
  return (
    <section
      id='access'
      className='container max-w-7xl mx-auto px-4 md:px-6 pt-28 md:pt-40 lg:pt-48'
    >
      <div className='flex flex-col justify-center items-center'>
        ...
        <h1 className='text-4xl md:text-6xl lg:text-7xl font-medium text-center mt-6 max-w-7xl mx-auto font-display'>
